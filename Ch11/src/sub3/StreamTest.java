...
public class StreamTest {
	public static void main(String[] args) {
		...
		pStream.forEach((person)->{System.out.println
			("Person [name="+ person.getName()+", age="+ person.getAge()+"]");
		});
		
		//ToString 사용하여 형식 지정함.
		Stream<Person> pStream2 = persons.stream();
		pStream2.forEach(System.out::println);
